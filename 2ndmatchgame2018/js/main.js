...
function flipOverCard() {
  ...
  this.innerHTML = '<img src= "images/king.jpeg"  alt="king"' + this.getAttribute('class') + 'jpeg'; 
  cardsInPlay.push(this);
  this.innerHTML = '<img src= "images/queen.jpeg"  alt="queen" + this.getAttribute('class') + 'jpeg'; 
  cardsInPlay.push(this);
